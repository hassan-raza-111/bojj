...
-- CreateEnum
CREATE TYPE "public"."NotificationType" AS ENUM ('NEW_BID', 'BID_ACCEPTED', 'BID_REJECTED', 'BID_WITHDRAWN', 'COUNTER_OFFER_RECEIVED', 'COUNTER_OFFER_ACCEPTED', 'COUNTER_OFFER_REJECTED', 'NEGOTIATION_LIMIT_REACHED', 'JOB_ASSIGNED', 'JOB_COMPLETED', 'JOB_CANCELLED', 'JOB_DISPUTED', 'PAYMENT_RECEIVED', 'PAYMENT_RELEASED', 'PAYMENT_DISPUTED', 'NEW_MESSAGE', 'NEW_REVIEW', 'ACCOUNT_VERIFIED', 'ACCOUNT_SUSPENDED', 'PROFILE_VERIFIED', 'PROFILE_REJECTED', 'SUPPORT_TICKET_REPLY', 'SYSTEM_ALERT', 'PAYMENT_REMINDER', 'JOB_EXPIRING', 'JOB_DEADLINE_REMINDER', 'MILESTONE_COMPLETED', 'NEW_JOB_POSTED', 'BULK_JOB_POSTED');
