...
const TicketDetailsModal: React.FC<TicketDetailsModalProps> = ({
  ...
  const fetchAdmins = async () => {
    try {
      ...
      setAdmins([
        { id: 'admin1', firstName: 'Admin', lastName: 'User', email: 'admin@bojj.com' },
        { id: 'admin2', firstName: 'Support', lastName: 'Team', email: 'support@bojj.com' },
      ]);
    } catch (error) {
  ...
  const handleUpdateTicket = async () => {
    ...
    setLoading(true);
    try {
      await apiService.support.updateTicket(ticket.id, {
        status,
        priority,
        adminResponse,
      });
  ...
  const handleAssignTicket = async () => {
    ...
    setLoading(true);
    try {
      await apiService.support.assignTicket(ticket.id, assignedToId);
            ...
            <CardContent className='space-y-4'>
              ...
              <div className='flex gap-2'>
                ...
                <Button 
                  ...
                  disabled={loading || assignedToId === (ticket.assignedToId || '')}
                  size='sm'
                >
                  Assign
                </Button>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                ...
                <div>
                  <label className='text-sm font-medium text-gray-600'>Update Priority</label>
