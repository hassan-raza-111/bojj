...
export const Sidebar = ({ userType }: SidebarProps) => {
  ...
  const navItems = userType === "customer" 
    ? [
        ...
        { name: "Jobs", path: `${baseRoute}/jobs`, icon: <Briefcase size={20} /> },
        { name: "Messages", path: `${baseRoute}/messages`, icon: <MessageSquare size={20} /> },
        { name: "Payments", path: `${baseRoute}/payments`, icon: <DollarSign size={20} /> },
        { name: "Support", path: `${baseRoute}/support`, icon: <LifeBuoy size={20} /> },
      ]
    : [
        { name: "Dashboard", path: baseRoute, icon: <Home size={20} /> },
        { name: "Jobs", path: `${baseRoute}/jobs`, icon: <Briefcase size={20} /> },
        { name: "Messages", path: `${baseRoute}/messages`, icon: <MessageSquare size={20} /> },
        { name: "Earnings", path: `${baseRoute}/earnings`, icon: <DollarSign size={20} /> },
        { name: "Support", path: `${baseRoute}/support`, icon: <LifeBuoy size={20} /> },
      ];
    ...
    >
      ...
      <SidebarFooter className="p-4 border-t">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-medium">{userType === "customer" ? "Customer" : "Vendor"}</p>
          </div>
        </div>
      </SidebarFooter>
    </ShadcnSidebar>
