...
import { CheckCircle2, LifeBuoy, Mail, TicketCheck, ChevronDown, ChevronRight } from "lucide-react";
...
const SupportPage = () => {
  ...
  const isDashboard = location.pathname.includes("customer") || location.pathname.includes("vendor");
  const layoutClass = isDashboard ? "" : "container max-w-6xl mx-auto py-12 px-6";
              ...
              {!ticketCreated ? (
                                ...
                                <div className="absolute z-50 w-full mt-1 bg-white dark:bg-gray-800 rounded-md shadow-lg border border-gray-200 dark:border-gray-700">
                                  {Object.entries(serviceCategories).map(([category, services]) => (
                                    ...
                                    >
                                      ...
                                      <div className={`absolute left-full top-0 w-64 bg-white dark:bg-gray-800 rounded-md shadow-lg border border-gray-200 dark:border-gray-700 ${activeCategory === category ? "block" : "hidden"} lg:group-hover:block`}>
                ...
                <>
                  <div className="text-center py-8">
                    ...
                    <h2 className="text-2xl font-bold mb-2 text-foreground">Ticket Created Successfully!</h2>
                    ...
                    <div className="p-4 bg-accent rounded-lg text-left mb-6 max-w-md mx-auto">
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <p className="text-sm font-medium text-right text-foreground">{ticketId}</p>
                        ...
                        <p className="text-sm font-medium text-right text-foreground">{new Date().toLocaleDateString()}</p>
                      </div>
                    </div>
                    <div className="flex gap-4 justify-center">
                      <Button variant="outline" onClick={() => setTicketCreated(false)} className="text-foreground">
