...
const SignUpPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to login page with type
      navigate(`/login?type=${userType}`);
    } catch (err: any) {
      toast({
  ...
  const serviceCategories = [
    "Home Renovation", "Plumbing", "Electrical", "Landscaping",
    "Cleaning", "Painting", "Carpentry", "HVAC", "Roofing", "Other",
  ];
        ...
        <div className="w-full max-w-lg">
          <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow border border-gray-200 dark:border-gray-700">
            <h1 className="text-2xl font-bold text-center mb-4">
              {userType === "vendor" ? "Join Bojj as a Verified Vendor" : "Create Your Customer Account"}
            </h1>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {userType === "vendor" && (
                <>
                  ...
                  <div className="space-y-3">
                    ...
                    <RadioGroup value={experienceLevel} onValueChange={setExperienceLevel} className="flex justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                <label htmlFor="terms" className="text-sm">
                  I agree to Bojj's{" "}
                  <Link to="/terms" className="text-bojj-primary hover:underline">Terms & Conditions</Link>
                </label>
              </div>
            ...
            <p className="mt-6 text-center text-sm">
              ...
              <Link to={`/login?type=${userType}`} className="text-bojj-primary hover:underline font-medium">
                Sign In
              </Link>
            </p>
          </div>
