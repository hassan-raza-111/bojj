...
const VendorDashboard = () => {
  ...
  return (
    <div className="p-4 md:p-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-8">
        <Card className="dark:bg-gray-950">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg font-medium">Available Jobs</CardTitle>
      ...
      {/* Jobs Tabs */}
      <Tabs defaultValue="available" onValueChange={setActiveTab} className="mt-6">
        <TabsList>
                ...
                <Card className="dark:bg-gray-950">
                  ...
                  <CardContent>
                    ...
                    <div className="flex space-x-3 mt-4">
                      <Link to={`/vendor-dashboard/bids/${job.id}/view`} className="flex-1 min-w-0">
                        <Button variant="outline" className="w-full">
                          View Details
                        </Button>
                      </Link>
                      
                      <Link to={`/vendor-dashboard/jobs/${job.id}/bid`} className="flex-1 min-w-0">
            ...
            {activeBids.map((bid) => (
              <Card key={bid.id} className="dark:bg-gray-950">
                ...
                <CardContent>
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-4">{bid.notes}</p>
                  
                  <div className="flex space-x-3 mt-4">
                    <Link to={`/vendor-dashboard/bids/${bid.id}/view`} className="flex-1 min-w-0">
                      <Button variant="outline" className="w-full">
                        View Details
                      </Button>
                    </Link>
                    
                    <Link to={`/vendor-dashboard/messages?jobId=${bid.jobId}&client=${encodeURIComponent(bid.customerName)}`} className="flex-1 min-w-0">
              ...
              <Card key={job.id} className="dark:bg-gray-950">
                ...
                <CardContent>
                  ...
                  <div className="flex space-x-3 mt-4">
                    ...
                    <Link to={`/vendor-dashboard/messages?jobId=${job.jobId}&client=${encodeURIComponent(job.customerName)}`} className="flex-1 min-w-0">
                      <Button className="w-full">
                        <MessageSquare className="mr-2 h-4 w-4" />
                        Message Client
                      </Button>
