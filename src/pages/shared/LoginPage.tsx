        ...
        <div className="w-full max-w-md">
          <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-venbid-dark dark:text-white">
                Welcome Back
              </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <Link
                    to="/forgot-password"
                    className="text-sm text-venbid-primary hover:underline"
                  >
                    Forgot Password?
                  </Link>
                </div>
              ...
              <Button
                type="submit"
                className="w-full bg-venbid-primary hover:bg-venbid-primary/90 text-white"
                disabled={loading}
              >
