...
const SupportTickets = () => {
  ...
  // Common vendor support categories
  const vendorCategories = [
    'BILLING', // Payment issues, withdrawal problems
    'TECHNICAL', // Platform issues, job posting problems
    'DISPUTE', // Customer disputes, quality issues
    'GENERAL', // Account verification, profile issues
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-700 rounded-lg p-6 text-white">
        <h1 className="text-2xl font-bold mb-2">Vendor Support Center</h1>
        <p className="text-green-100">
          Get help with your vendor account, payments, jobs, and more
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="hover:shadow-lg transition-shadow cursor-pointer">
          ...
          <CardContent>
            <p className="text-xs text-gray-500">
              Having trouble with payments or withdrawals?
            </p>
        ...
        <Card className="hover:shadow-lg transition-shadow cursor-pointer">
          ...
          <CardContent>
            <p className="text-xs text-gray-500">
              Need help with job applications or client communication?
            </p>
            <Button variant="link" size="sm" className="p-0 h-auto mt-2">
              Get Help →
            </Button>
        ...
        <Card className="hover:shadow-lg transition-shadow cursor-pointer">
          ...
          <CardContent>
            <p className="text-xs text-gray-500">
              Profile verification or account setup issues?
            </p>
            <Button variant="link" size="sm" className="p-0 h-auto mt-2">
              Get Help →
            </Button>
                        ...
                        <SelectContent>
                          {vendorCategories.map((category) => (
                            <SelectItem key={category} value={category}>
                              {category === 'BILLING' && '💳 Payment & Billing'}
                              {category === 'TECHNICAL' &&
                                '🔧 Technical Issues'}
                              {category === 'DISPUTE' && '⚖️ Disputes'}
