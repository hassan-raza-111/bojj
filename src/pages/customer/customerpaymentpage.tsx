  ...
  const paymentContent = (
    <div className='max-w-3xl mx-auto px-4 py-10'>
      <h1 className='text-3xl font-bold text-foreground mb-2'>
        Secure Payments & Easy Transactions
      </h1>
          ...
          <Card>
            ...
            <CardFooter className='flex flex-col items-start sm:items-stretch space-y-4'>
              ...
              <div className='text-sm text-muted-foreground'>
                <strong>Payment Protection:</strong> Your payment is protected
                by our secure system. Funds are held safely until you confirm
